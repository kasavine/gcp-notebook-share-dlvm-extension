...
gcloud compute ssh "jupyter@${INSTANCE_NAME}" -- "sudo service /opt/anaconda3/bin/jupyter restart"
gcloud compute ssh "jupyter@${INSTANCE_NAME}" -- "cd /home/jupyter/nova && sudo /opt/anaconda3/bin/jupyter labextension install"
